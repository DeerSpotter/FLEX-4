...
ifneq ($(wildcard tools/fix-force-open-logs-row-registration.py),)
$(shell python3 tools/fix-force-open-logs-row-registration.py >/dev/null 2>&1 || true)
endif
...
ifneq ($(wildcard tools/fix-force-open-logs-duplicate-block.py),)
